...
type Snippet = { label: string; insertText: string; kind: monaco.languages.CompletionItemKind; detail?: string };

const CPP: Snippet[] = [
  { label: '#include', insertText: '#include <$1>', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'using namespace std;', insertText: 'using namespace std;', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'main', insertText: 'int main() {\n\t$1\n\treturn 0;\n}', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'for', insertText: 'for (int i = 0; i < $1; i++) {\n\t$2\n}', kind: monaco.languages.CompletionItemKind.Snippet },
  ...
  { label: 'vector', insertText: 'std::vector<$1> $2;', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'string', insertText: 'std::string $1;', kind: monaco.languages.CompletionItemKind.Snippet },
  ...
  { label: 'template', insertText: 'template <typename $1>\n$2', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'try', insertText: 'try {\n\t$1\n} catch (const std::exception& e) {\n\t$2\n}', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'typedef', insertText: 'typedef $1 $2;', kind: monaco.languages.CompletionItemKind.Snippet },
  ...
  { label: 'static_cast', insertText: 'static_cast<$1>($2)', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'dynamic_cast', insertText: 'dynamic_cast<$1>($2)', kind: monaco.languages.CompletionItemKind.Snippet },
];
...
const JAVA: Snippet[] = [
  ...
  { label: 'if', insertText: 'if ($1) {\n\t$2\n}', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'else', insertText: 'else {\n\t$1\n}', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'sysout', insertText: 'System.out.println($1);', kind: monaco.languages.CompletionItemKind.Snippet, detail: 'System.out.println' },
  { label: 'Scanner', insertText: 'Scanner $1 = new Scanner(System.in);', kind: monaco.languages.CompletionItemKind.Snippet },
  ...
  { label: 'protected', insertText: 'protected ', kind: monaco.languages.CompletionItemKind.Keyword },
  { label: 'static', insertText: 'static ', kind: monaco.languages.CompletionItemKind.Keyword },
  ...
  { label: 'ArrayList', insertText: 'ArrayList<$1> $2 = new ArrayList<>();', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'HashMap', insertText: 'HashMap<$1, $2> $3 = new HashMap<>();', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'HashSet', insertText: 'HashSet<$1> $2 = new HashSet<>();', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'try', insertText: 'try {\n\t$1\n} catch (Exception e) {\n\t$2\n}', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'return', insertText: 'return $1;', kind: monaco.languages.CompletionItemKind.Snippet },
...
const PYTHON: Snippet[] = [
  ...
  { label: 'for', insertText: 'for $1 in range($2):\n\t$3', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'for each', insertText: 'for $1 in $2:\n\t$3', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'while', insertText: 'while $1:\n\t$2', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'if', insertText: 'if $1:\n\t$2', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'elif', insertText: 'elif $1:\n\t$2', kind: monaco.languages.CompletionItemKind.Snippet },
  ...
  { label: 'import', insertText: 'import $1', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'from', insertText: 'from $1 import $2', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'class', insertText: 'class $1:\n\tdef __init__(self$2):\n\t\t$3', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'try', insertText: 'try:\n\t$1\nexcept $2:\n\t$3', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'with', insertText: 'with open($1) as $2:\n\t$3', kind: monaco.languages.CompletionItemKind.Snippet },
  { label: 'return', insertText: 'return $1', kind: monaco.languages.CompletionItemKind.Snippet },
  ...
  { label: 'lambda', insertText: 'lambda $1: $2', kind: monaco.languages.CompletionItemKind.Snippet },
