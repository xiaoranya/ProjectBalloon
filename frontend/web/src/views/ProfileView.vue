<template>
  <main class="profile-page">
    <header><div><p class="eyebrow">Account</p><h1>账户设置</h1><p>维护个人显示信息并管理登录密码。</p></div><RouterLink to="/practice">返回练习</RouterLink></header>
...
<style scoped>.profile-page{max-width:760px;margin:0 auto;padding:28px 20px}.profile-page>header{display:flex;justify-content:space-between;align-items:end;border-bottom:1px solid #dcdfe6;padding-bottom:18px;margin-bottom:20px}.profile-page h1,.profile-page h2,.profile-page p{margin:0}.profile-page header p:not(.eyebrow){color:#606266;margin-top:6px}.profile-card{max-width:560px}.password-row{display:flex;justify-content:space-between;align-items:center;gap:20px}.password-row p{color:#606266;margin-top:6px}@media(max-width:600px){.password-row{align-items:flex-start;flex-direction:column}}</style>
