...
describe('PracticeView', () => {
  beforeEach(() => {
    ...
    mocks.editorial.mockResolvedValue({
      problemId: 2,
      langCode: 'en',
      title: '题解',
      bodyHtml: '<p>Idea</p>',
  ...
  it('loads practice state, selects the requested problem, and toggles favorites', async () => {
    ...
    await wrapper
      ...
      .find((button) => button.text().includes('pending'))!
      .trigger('click');
