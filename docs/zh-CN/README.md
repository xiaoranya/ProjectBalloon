...
| 使用平台的选手 | [选手指南](user/contestant/) |
| 比赛管理员 | [管理员指南](user/admin/) |
| 现场工作人员（大屏、气球、打印、Resolver、颁奖） | [现场运营指南](user/onsite/) |
| 部署或运维服务器 | [安装](ops/install.md) 与 [运维](ops/ops.md) |
| 查询配置变量或端点 | [配置参考](ops/configuration.md) 与 [API 契约](https://github.com/xiaoranya/ProjectBalloon/blob/main/docs/api/openapi.yaml) |
...
新增或修改文档时，请遵循[文档写作规范](STYLE.md)。贡献流程见 [`CONTRIBUTING.md`](https://github.com/xiaoranya/ProjectBalloon/blob/main/CONTRIBUTING.md)。
