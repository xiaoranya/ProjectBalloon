...
impl BalloonService {
    ...
    pub(super) async fn dispatch_policy(
        &self,
        contest_id: i64,
        actor: &AuthUser,
    ...
    pub(super) async fn update_dispatch_policy(
        &self,
        contest_id: i64,
...
pub(super) fn validate_status(status: Option<String>) -> Result<Option<String>, AppError> {
    status
        .map(|status| {
...
pub(super) fn validate_reason(reason: Option<String>) -> Result<String, AppError> {
...
pub(super) fn validate_note(note: Option<String>) -> Result<Option<String>, AppError> {
    note.map(|note| {
