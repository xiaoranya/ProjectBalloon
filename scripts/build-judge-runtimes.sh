...
docker build --pull=false -t judge-runtime-go:1.27 "$RUNTIME_ROOT/go"
docker build --pull=false -t judge-runtime-rust:1.98 "$RUNTIME_ROOT/rust"
...
for image in \
    ...
    judge-runtime-go:1.27 \
    judge-runtime-rust:1.98
do
